		...
		<div className="w-85 lg:w-100">
			<form className="">
				...
				<div className="flex flex-col justify-center items-center gap-6">
					...
					<button className='px-6 py-3 font-bold text-white bg-[#00B2A5] transition-all duration-300 rounded-xl text-lg shadow-lg transform hover:scale-105 hover:shadow-xl outline-none w-full cursor-pointer' onClick={() => navigate('dashboard')} >
						Sign In
					</button>
				</div>
			</form>
