...
const SignUp = ({ setSignInVisible }: any) => {
	...
	return (
		<div className="w-85 lg:w-100">
			<form className="">
				<p className="text-3xl font-bold mb-4 text-center">Sign Up</p>
				<div className="flex flex-col justify-center items-center gap-6">
					...
					<div className="w-full flex items-center bg-gray-100 rounded-xl pr-3 transform hover:scale-105 transition-all duration-300">
						...
						<div className="cursor-pointer">
							{isPasswordVisible1 ? <Eye size={20} color="gray" onClick={() => setPasswordVisible1(false)} /> : <EyeOff size={20} color="gray" onClick={() => setPasswordVisible1(true)} />}
						</div>
					</div>
					<div className="w-full flex items-center bg-gray-100 rounded-xl pr-3 transform hover:scale-105 transition-all duration-300">
						<input
							...
							className="outline-none bg-gray-100 px-6 py-3 rounded-xl w-full"
						/>
						<div className="cursor-pointer">
			...
			<p className="text-center text-gray-500 mt-5">Already have an account? <span className="underline hover:font-bold text-[#00B2A5] cursor-pointer" onClick={() => setSignInVisible(true)} >Sign In</span></p>
		</div>
	)
}
